...
<br>
<div align="center">
  <h1 align="center">Walkman Playlist Manager</h1>
</div>
...
<!--ABOUT THE PROJECT -->
## About The Project
Designed to help people with Sony Walkman add, modify, or remove playlist from their walkman without having to go
through the menus. With the Walkman connected to the computer, the user can select the MUSIC folder on the walkman,
and then mange the playlist(s) saved in the MUSIC folder.
...
<!--Running the Program-->
## Running the Program
You can download the executable for Windows, Linux, or Mac from the <a href="">releases page</a>.
